...
out vec3 EyeDirection_cameraspace3;
out vec3 LightDirection_cameraspace3;
out vec3 Normal_cameraspace3;

out vec3 EyeDirection_cameraspace4;
out vec3 LightDirection_cameraspace4;
out vec3 Normal_cameraspace4;
...
void main()
{
    ...
    vec3 vertexPosition_cameraspace3 = ( view * model * vec4(aPos,1)).xyz;
    EyeDirection_cameraspace3 = vec3(0,0,0) - vertexPosition_cameraspace3;
    vec3 LightPosition_cameraspace3 = ( view * vec4(lightPosition3,1)).xyz;
    LightDirection_cameraspace3 = LightPosition_cameraspace3 + EyeDirection_cameraspace3;
    Normal_cameraspace3 = ( view * model * vec4(aNormal,0)).xyz;

    vec3 vertexPosition_cameraspace4 = ( view * model * vec4(aPos,1)).xyz;
    EyeDirection_cameraspace4 = vec3(0,0,0) - vertexPosition_cameraspace4;
    vec3 LightPosition_cameraspace4 = ( view * vec4(lightPosition4,1)).xyz;
    LightDirection_cameraspace4 = LightPosition_cameraspace3 + EyeDirection_cameraspace4;
    Normal_cameraspace4 = ( view * model * vec4(aNormal,0)).xyz;
